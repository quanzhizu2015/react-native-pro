...
import CalculationInviteItem from './CalculationInviteItem';
import {appState, miningPoolInvite, transferRecord} from '../../comm/sdk';
import Toast from 'teaset/components/Toast/Toast';

export default class CalculationInvitePage extends NavigationPage {
    ...
    renderNavigationBar(): * {
        return  <NavigationBar
            title={<View><Label style={{fontSize:18,color:'#fff',fontFamily:FONT_R}}>{appState.lan.myPool.title9}</Label></View>}
    ...
    renderItem({item, index}) {
        ...
        return <CalculationInviteItem item={item}/>
